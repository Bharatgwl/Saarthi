...
export default function VendorMessages() {
  const [conversations, setConversations] = useState([
    ...
    },
    {
      ...
      lastMessage: 'Thank you for your inquiry. We have the spices you need.',
    ...
    },
    {
      ...
      supplierLocation: 'Delhi',
      lastMessage: 'The milk delivery schedule has been updated.',
  ...
  const conversationMessages = {
    'conv-1': [
      { id: 1, sender: 'supplier', text: 'Hello! I received your order for vegetables.', timestamp: '2024-01-15T09:00:00Z' },
      { id: 2, sender: 'vendor', text: 'Great! Can you confirm the delivery time?', timestamp: '2024-01-15T09:05:00Z' },
      { id: 3, sender: 'supplier', text: 'Sure! We can deliver between 8-10 AM tomorrow.', timestamp: '2024-01-15T09:10:00Z' },
      { id: 4, sender: 'vendor', text: 'Perfect! That works for me.', timestamp: '2024-01-15T09:15:00Z' },
      { id: 5, sender: 'supplier', text: 'Your order has been confirmed and will be delivered tomorrow.', timestamp: '2024-01-15T10:30:00Z' }
    ],
    'conv-2': [
    ...
    'conv-3': [
      ...
      { id: 4, sender: 'supplier', text: 'The milk delivery schedule has been updated.', timestamp: '2024-01-15T08:45:00Z' }
    ]
  };
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900">{conversation.supplierName}</h3>
                      <p className="text-xs text-gray-500">{conversation.supplierLocation}</p>
                    </div>
                  </div>
            ...
            <>
              <div className="p-4 border-b border-gray-200 bg-gray-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">{selectedConversation.supplierName}</h3>
                    <p className="text-sm text-gray-500">
                      {selectedConversation.isOnline ? 'Online' : 'Offline'} • {selectedConversation.supplierLocation}
                    </p>
                  </div>
                </div>
              </div>
