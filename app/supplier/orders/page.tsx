...
export default function SupplierOrders() {
  const [orders, setOrders] = useState([
    { id: 'ORD-001', vendor: 'Street Food Corner', vendorLocation: 'Delhi', items: 'Onions (50kg), Tomatoes (30kg), Potatoes (25kg)', amount: 2450, status: 'Processing', date: '2024-01-15', priority: 'High' },
    { id: 'ORD-002', vendor: 'Spicy Delights', vendorLocation: 'Mumbai', items: 'Garam Masala (5kg), Turmeric (2kg), Cumin (3kg)', amount: 1200, status: 'Shipped', date: '2024-01-14', priority: 'Medium' },
    { id: 'ORD-003', vendor: 'Tasty Treats', vendorLocation: 'Delhi', items: 'Cooking Oil (20L), Ghee (5kg)', amount: 3200, status: 'Delivered', date: '2024-01-13', priority: 'Low' },
    { id: 'ORD-004', vendor: 'Food Paradise', vendorLocation: 'Bangalore', items: 'Chicken (15kg), Mutton (10kg)', amount: 4800, status: 'Processing', date: '2024-01-12', priority: 'High' },
    { id: 'ORD-005', vendor: 'Chaat Master', vendorLocation: 'Delhi', items: 'Milk (40L), Paneer (8kg), Curd (5kg)', amount: 1800, status: 'Delivered', date: '2024-01-11', priority: 'Medium' }
  ]);
                  ...
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div>
                        ...
                        <div className="text-xs text-gray-400">{order.vendorLocation}</div>
                      </div>
                    </td>
            ...
            <div className="bg-white p-6 rounded-lg max-w-md w-full mx-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Vendor: {selectedOrder?.vendor}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    New Status
