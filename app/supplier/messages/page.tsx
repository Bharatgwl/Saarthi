    ...
    "conv-1": [
      {
        id: 1,
        sender: "vendor",
        text: "Hello! I received your order for vegetables.",
        timestamp: "2024-01-15T09:00:00Z",
      },
      {
        id: 2,
        sender: "supplier",
        text: "Great! Can you confirm the delivery time?",
        timestamp: "2024-01-15T09:05:00Z",
      },
      {
        id: 3,
        sender: "vendor",
        text: "Sure! We can deliver between 8-10 AM tomorrow.",
    ...
    "conv-2": [
      {
        id: 1,
        sender: "vendor",
        text: "Hi, I need some spices for my street food stall.",
        timestamp: "2024-01-15T08:30:00Z",
      },
      {
        id: 2,
        sender: "supplier",
        text: "Hello! What specific spices do you need?",
        timestamp: "2024-01-15T08:45:00Z",
      },
      {
        id: 3,
        sender: "vendor",
        text: "I need garam masala, turmeric, and red chili powder.",
        timestamp: "2024-01-15T09:00:00Z",
      },
      {
        id: 4,
        sender: "supplier",
        text: "Thank you for your inquiry. We have the spices you need.",
        timestamp: "2024-01-15T09:15:00Z",
      },
    ],
    "conv-3": [
      {
        id: 1,
        sender: "supplier",
        text: "Good morning! Your regular milk order is ready.",
        timestamp: "2024-01-15T08:00:00Z",
      },
      {
        id: 2,
        sender: "vendor",
        text: "Thanks! Same time as usual?",
        timestamp: "2024-01-15T08:15:00Z",
      },
      {
        id: 3,
        sender: "supplier",
        text: "Actually, we need to deliver 30 minutes earlier today.",
        timestamp: "2024-01-15T08:30:00Z",
      },
      {
        id: 4,
        sender: "vendor",
        text: "Can you deliver 30 minutes earlier today?",
        timestamp: "2024-01-15T08:45:00Z",
      },
    ],
  };
  ...
  const handleConversationSelect = (conversation: any) => {
    ...
    setMessages(
      conversationMessages[
        conversation.id as keyof typeof conversationMessages
      ] || []
    );
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      {selectedConversation.vendorLocation}
                    </p>
                  </div>
                </div>
              </div>
